...
<style>
    ...
    /* Header Section (Biru Gradient Lebar) - Diperamping */
    .header-section {
    ...
    /* Custom Month Picker inside Header */
    .month-picker-box {
        background: white;
...
<div class="container-fluid px-md-4">
    ...
    <div class="header-section">
        <div class="header-content">
            ...
            <p>Pantau analisis poin dan riwayat presensi bulanan.</p>
        </div>
        <div class="d-flex align-items-center gap-3">
             ...
             {{-- User Badge --}}
             <div class="bg-white text-primary p-2 px-3 rounded-pill fw-bold shadow-sm d-none d-lg-flex align-items-center gap-2" style="height: 50px; border: 2px solid #e0e7ff;">
                <i class="bi bi-person-circle fs-5"></i>
                <span class="small">{{ $user->nama }}</span>
             </div>
        </div>
    </div>

    <div class="row g-4">
        {{-- Sisi Kiri: Ringkasan Poin & Ranking Poin --}}
